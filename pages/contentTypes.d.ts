...
export interface ApiAboutPageAboutPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    Teams: Attribute.Component<'shared.our-team-card', true>;
  ...
  attributes: {
    ...
    Author: Attribute.Enumeration<
      [
        'Indra Kurniawan',
        'Izzul Qudsi',
        'John Papilon Steven Guntoro',
        'Mordekhai',
        'Muhamad Reza Noviardi',
        'Praviandy Gustandika',
        'Rahmantara Trichandi'
      ]
    > &
      Attribute.Required;
    ReadMoreURL: Attribute.String;
    seo: Attribute.Component<'shared.seo'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiError404PageError404Page extends Schema.SingleType {
...
export interface ApiProjectsPageProjectsPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    Projects: Attribute.Component<'shared.project', true>;
    seo: Attribute.Component<'shared.seo'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPublicationPublication extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Abstract: Attribute.RichText & Attribute.Required;
    ReadMoreUrl: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
